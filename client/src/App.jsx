...
export default function App() {
  ...
  const search = async () => {
    ...
    try {
      ...
      if (e.name !== "AbortError") setError("Something went wrong. Is the server running?");
    } finally {
      setLoading(false);
    }
  };
            ...
            <div style={{ flex: 1 }}>
              ...
              <input
                ...
                style={{
                  ...
                  outline: "none", boxSizing: "border-box", caretColor: "#818CF8",
                }}
                        ...
                        <div style={{ display: "flex", gap: "8px", flexWrap: "wrap", marginBottom: ac.notes ? "10px" : 0 }}>
                          ...
                          {ac.era && (
                            <span style={{
                              ...
                              padding: "3px 10px", borderRadius: "100px", fontSize: "12px", fontWeight: 600,
                            }}>{eraLabel[ac.era] || ac.era}</span>
                          )}
                        </div>
                        {ac.notes && (
                          <p style={{ margin: "8px 0 0", fontSize: "13px", color: "#94A3B8", lineHeight: 1.5 }}>{ac.notes}</p>
                        )}
                      </div>
